...
export default function LearnWordNavbar() {
    return (
        <div className="absolute top-0 left-0 w-full px-6 pt-0 flex justify-between items-start z-50 pointer-events-none font-dynapuff" style={{ fontFamily: 'var(--font-dynapuff)' }}>
            {/* Left - Title */}
